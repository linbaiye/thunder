 ...
 */
public class UnitTestCodeCompleter implements CodeCompleter {
    ...
    private final static Logger LOGGER = LoggerFactory.getLogger(UnitTestCodeCompleter.class);
    ...
    private UnitTestCodeCompleter(PsiJavaFile psiJavaFile) {
    ...
    public static Optional<UnitTestCodeCompleter> create(PsiJavaFile psiJavaFile) {
        ...
        return Optional.of(new UnitTestCodeCompleter(psiJavaFile));
    }
