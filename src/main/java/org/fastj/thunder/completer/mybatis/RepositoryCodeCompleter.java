...
public class RepositoryCodeCompleter implements CodeCompleter {
    ...
    public RepositoryCodeCompleter(RepositoryContextAnalyser contextParser) {
        this.psiMethod  = null;
    ...
    public RepositoryCodeCompleter(PsiMethod method,
    ...
    public static Optional<RepositoryCodeCompleter> from(PsiMethod method,
                                                         PsiClass entityClass,
                                                         PsiElement focusedElement,
                                                         PsiField daoOrRepositoryField) {
        if (method == null || entityClass == null || focusedElement == null || daoOrRepositoryField == null) {
            ...
            return Optional.of(new RepositoryCodeCompleter(method, entityClass, focusedElement, daoOrRepositoryField));
        }
    }
}
