...
import org.fastj.thunder.completer.UnitTestCodeCompleter;
import org.intellij.lang.annotations.Language;

import java.util.Optional;


public class UnitTestCodeCompleterTest extends LightJavaCodeInsightFixtureTestCase {
    ...
    public void testModifyUnitTestClass() throws Exception {
        ...
        Optional<UnitTestCodeCompleter> optional = UnitTestCodeCompleter.create((PsiJavaFile)psiFiles[0]);
        UnitTestCodeCompleter modifier = optional.orElseThrow(IllegalArgumentException::new);
        modifier.tryComplete();
