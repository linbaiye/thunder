...
import org.fastj.thunder.completer.mybatis.RepositoryCodeCompleter;
import org.intellij.lang.annotations.Language;

import java.util.Optional;

public class RepositoryCodeCompleterTest extends LightJavaCodeInsightFixtureTestCase {
    ...
    public void testQuery() {
        ...
        PsiClass entity = JavaPsiFacade.getInstance(getProject()).findClass("org.fastj.thunder.model.Entity",
                ProjectScope.getProjectScope(getProject()));
        Optional<RepositoryCodeCompleter> optional = RepositoryCodeCompleter.from(method, entity, method.getBody().getChildren()[2], dao);
